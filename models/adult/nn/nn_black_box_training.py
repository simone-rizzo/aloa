...
pickle.dump(scaler, open("nn_scaler_23_10_2022.sav", 'wb'))
...
history = model.fit(train_set, train_label, validation_split=0.2, epochs=250, batch_size=4096)
...
# Saving the model
model.save('nn_blackbox_23_10_2022.h5')
