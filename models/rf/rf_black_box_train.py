...
"""rf = RandomForestClassifier(bootstrap=False, class_weight='balanced',
                       ...
                       max_leaf_nodes=None, min_impurity_decrease=0.0, min_samples_leaf=5,
                       min_samples_split=30, min_weight_fraction_leaf=0.0,
                       n_estimators=350, n_jobs=None, oob_score=False,
                       random_state=0, verbose=0, warm_start=False)"""
rf = RandomForestClassifier()
rf.fit(train_set, train_label.values.ravel())
filename = 'measures_rf_black_box_original.sav'
...
print(report)
write_report = open("measures_rf_black_box_training.txt", "w")
...
print(report)
write_report = open("measures_rf_black_box_test.txt", "w")
write_report.write(report)
